<link href="/views/assets/css/login/login.css" rel="stylesheet">
...
<section id="form-login">
    ...
    <main class="form-signin">
        ...
        <form method="POST">
            ...
            <h1 class="h3 mb-3 fw-normal text-center"><span class="h1" data-feather="code"></span>Landing Page Builder</h1>
            ...
            <?php require_once "controllers/admins.controller.php";
